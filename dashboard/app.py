...
data = {
    ...
    'cid': np.random.randint(1, 13, size=100),  # Assuming 12 companies
    'value': np.random.uniform(low=10, high=100, size=100),
...
daystocks_data = {
    'date': np.random.choice(date_range, size=100),
    'cid': np.random.randint(1, 13, size=100),
...
companies_data = {
    'id': np.arange(1, 13),
    'name': [f'Action {i}' for i in range(1, 13)],
    'mid': np.random.randint(1, 8, size=12),  # Assuming 7 markets
    'symbol': [f'SYM{i}' for i in range(1, 13)],
    'isin': [f'IS{i:010}' for i in range(1, 13)],
    'boursorama': [f'BOUR{i}' for i in range(1, 13)],
    'euronext': [f'EUR{i}' for i in range(1, 13)],
    'pea': np.random.choice([True, False], size=12),
    'sector1': [f'Sector1_{i}' for i in range(1, 13)],
    'sector2': [f'Sector2_{i}' for i in range(1, 13)],
    'sector3': [f'Sector3_{i}' for i in range(1, 13)],
}
